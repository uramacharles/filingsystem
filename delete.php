...
<div class="w3-main" id="main">
  ...
  <div class="container" id="hide">
    <div class="container">
      ...
      <div class="row">
        <h2 class="page-header text-center" style="margin: 30px 20px"><span class="fa fa-edit"></span> Delete document</h2>
        ...
        <div class="col-md-12">
          ...
          <?php if($conf == "YES"): ?>
            ...
            <?php if(isset($_SESSION["done"])): ?>
              <a href="documents.php"><input type="button" class="btn btn-primary" value="Return To Documents"/></a>
            <?php endif; ?>
          <?php else: ?>
            <form action="<?php $_PHP_SELF; ?>" method="POST" id="postform" enctype="multipart/form-data">
